...
# Database — PostgreSQL (DATABASE_URL env orqali)
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('PGDATABASE', 'real_holat'),
...
if not DEBUG:
    # Railway proxy HTTPS terminate qiladi — bu header bilan Django HTTPS ni taniydi
    SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')
    SECURE_SSL_REDIRECT = True
    SECURE_HSTS_SECONDS = 31536000
    SECURE_HSTS_INCLUDE_SUBDOMAINS = True
    SECURE_CONTENT_TYPE_NOSNIFF = True
    # X_FRAME_OPTIONS = 'DENY' — Telegram WebApp iframe ichida ishlaydi, DENY o'chirilgan
